define('header_profile.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <a class=\"header-profile-welcome-link\" href=\"#\" data-toggle=\"dropdown\"><i class=\"header-profile-welcome-user-icon\"></i> "
  ...
  return " <div class=\"header-profile-menu-login-container\"><ul class=\"header-profile-menu-login\"><li><i class=\"header-profile-login-icon\"></i></li><li><a class=\"header-profile-login-link\" data-touchpoint=\"login\" data-hashtag=\"login-register\" href=\"#\"> "
