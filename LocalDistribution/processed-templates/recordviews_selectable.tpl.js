define('recordviews_selectable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <tr class=\"recordviews-selectable-row "
    ...
    + "></td><td class=\"recordviews-selectable-td-title\"> "
